...
const categoryMeta: Record<string, { title: string; description: string; keywords?: string[] }> = {
  "acoustic-stands": {
    ...
    description:
      "Акустические стойки ручной работы на заказ. Стойки под акустические колонки из массива дерева и стали. Комплект пары от 16 000 ₽. Индивидуальные размеры и высота, изготовление 14 дней.",
    keywords: [
      "акустические стойки",
  ...
  "hifi-stands": {
    ...
    description:
      "HI-FI стойки ручной работы из массива дерева и стали. Под усилители, ЦАП, виниловые проигрыватели. Индивидуальные размеры и отделка, изготовление 14 дней.",
  },
  "acoustic-panels": {
