...
export const metadata: Metadata = {
  ...
  description:
    "Купить акустические стойки на заказ. Стойки под акустические колонки ручной работы — массив дерева, сталь, виброразвязка. Комплект пары от 16 000 ₽. Изготовление 14 дней, доставка по России.",
  openGraph: {
    title: "StandMuse — Акустические стойки ручной работы на заказ",
    description:
      "Стойки для акустических колонок из массива дерева и стали. Комплект пары от 16 000 ₽, изготовление 14 дней.",
