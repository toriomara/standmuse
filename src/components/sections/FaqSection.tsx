...
const faqs = [
  ...
  },
  {
    ...
    a: "Кварцевый песок внутри металлической колонны — это инертная масса. Он поглощает механические вибрации стойки, не позволяя им передаваться на акустику. 5 кг песка + металлическая колонна = серьёзный демпфер.",
  },
  {
